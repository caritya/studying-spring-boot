...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
	...
	public IngredientByIdConverter(IngredientRepository ingredientRepo) {
		 ...
		 * Type.WRAP)); ingredientMap.put("COTO", new Ingredient("COTO",
		 * "Corn Tortilla", Type.WRAP)); ingredientMap.put("GRBF", new
		 * Ingredient("GRBF", "Ground Beef", Type.PROTEIN)); ingredientMap.put("CARN",
		 ...
		 * Type.CHEESE)); ingredientMap.put("SLSA", new Ingredient("SLSA", "Salsa",
		 * Type.SAUCE)); ingredientMap.put("SRCR", new Ingredient("SRCR", "Sour Cream",
		 * Type.SAUCE));
		 */
